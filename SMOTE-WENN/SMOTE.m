...
function sample=SMOTE(pos_data,num_new,k,AttVector,attribute)
% Usage:
...
%     pos_data   : orginal minority class samples. No.instances * No.attribute
%     num_new  : number of new samples to generate
...
%     number of nearest neighbours can not be greater than num_pos-1
    if(k > num_pos-1)
        k = num_pos-1;
